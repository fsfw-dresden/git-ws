...
\colouredbox{magenta}{
	\begin{center}\section{Erstellen und klonen von Repositories}\end{center}
...
\colouredbox{pink}{
	\begin{center}\section{Änderungen von upstream (dt.: ???) erhalten}\end{center}
...
\par fsfw git-Spickzettel – Datum: \today \ – Version \Version\
