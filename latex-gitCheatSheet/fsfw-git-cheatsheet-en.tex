...
\setmarginsrb{1.1cm}{9mm}% left, top
...
% \definecolorset{hsb}{}{}{red,0,.1,0.95;orange,.1,.1,0.95;green,.25,.1,0.95;yellow,.15,.1,0.95}
% \definecolorset{hsb}{}{}{blue,.55,.1,0.95;purple,.7,.1,0.95;pink,.8,.1,0.95;blue2,.58,.1,0.95}
% \definecolorset{hsb}{}{}{magenta,.9,.1,0.95;green2,.29,.1,0.95;gray2,.6,.01,0.85}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\parbox{7cm}{\vspace*{-3cm}Hochschulgruppe für Freie Software und Freies Wissen \\ \url{https://fsfw-dresden.de}}\hfill\includegraphics[width=0.1\textwidth]{../img-src/fsfw-logo-with-text.pdf}
...
\par FSFW git CheatSheet – Version \Version\par
