...
\subtitle{Erstsemester-Einführung Informatik, 07.10.2019}
...
\begin{frame}[label=ct1]
  ...
  \begin{itemize}
  \item Hochschulgruppe an der TU (gegründet 2014, ca. 7 P.)
...
\begin{frame}[label=ct1b,t]
  \frametitle{Projekt Uni-Stick (4. Auflage)}

  \begin{itemize}
  \item \textbf{3000} Flyer in Ersti-Tüten: \textbf{Gutscheine} für 8\,GB Stick mit freier Software
    fürs Studium, Sticks-Beschaffung mit Geld von StuRä
  \item Live-Linux / freie Windows-Programme
    \pause
  \item Vorbereitung: Arbeit + Spaß + Lernen
    \pause
  \item Ist gut angekommen (ca. 250 TN)
  \end{itemize}

  \begin{textblock*}{40mm}[0.,0.](83mm,42mm)
    \visible<2->{
      \includegraphics[width=40mm]{img-src/usb-hub}
    }
  \end{textblock*}

  \begin{textblock*}{55mm}[0.,0.](15mm,57mm)
    \visible<3->{
  ...
  \begin{textblock*}{55mm}[0.,0.](75mm,76mm)
    \visible<4->{
      Ausgabe: 4.11.2019 APB, E023\\

      Infos/Anmeldung:
      {\small  \href{https://fsfw-dresden.de/uni-stick}{fsfw-dresden.de/uni-stick}}
    }
  \end{textblock*}
%
...
\visible<3->
{
Seit 2016: Git $\hat{=}$ defacto Standard
}
\end{center}
\end{textblock*}
...
\visible<4->{
\includegraphics[width=56mm]{img-src/git-prompt-snapshot1}
}
\end{textblock*}
...
\begin{Large}Bits und Bäume\end{Large}  \quad \hspace{12mm}\raisebox{-8mm}{\includegraphics[width=4cm]{img-src/extern/bub-logo.png}}
\end{center}

\begin{itemize}
\vspace{-3mm}
\item[]
%    \item Bits und Bäume \quad \hspace{12mm}\raisebox{-8mm}{\includegraphics[width=2cm]{img-src/extern/bub-logo.png}}
   \begin{itemize}
    \item Digitalisierung und Nachhaltigkeit verbinden
    \item Ressourcen, Freie Software, Privatsphäre, Demokratie, ...
    \item Größeres Treffen: 23.10., 19:00 Uhr, \href{https://osm.org/go/0MLhQbbYc?node=3140655489}{Rosenwerk}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=schluss30]{Schlussbemerkungen (3): Blick übern Tellerrand}


\begin{textblock*}{40mm}[0.,0.](75mm,20mm)

 \includegraphics[width=3cm]{img-src/extern/urv-plakat-2019-2-A4.jpg}
\end{textblock*}

\begin{itemize}
\vspace{-3mm}
   \item TU--Umweltinitiative
   \begin{itemize}
    \item Umweltringvorlesungen ab
    \item Offenes Grillen/Essen: 24.10.
    \item Wandern: 02.11.
...
%   \item[]\bigskip
  ...
  \pause
 \item Students4Future:\\
%  Semesterauftakt (25. Okt.)
% \vspace{-8mm}
   ...
   \begin{itemize}
    ...
    \item []
    \item []
    \item [] \hspace{40mm} $\rightarrow$ \url{https://fffdd.de}
    \item []
   \end{itemize}
\end{itemize}

\begin{textblock*}{40mm}[0.,0.](20mm,47mm)
\visible<2->{
\includegraphics[width=3.5cm]{img-src/extern/fff_auftakttreffen.pdf}
}
\end{textblock*}
