...
\begin{itemize}
 \item \texttt{printf "{}Hallo\textbackslash{}nWelt\textbackslash{}n"{} > README.md}
 \item \texttt{git status}
 \item \texttt{git add README.md} \qquad \visible<1->{{\scriptsize Tipp: Auto-Vervollständigung mit TAB}}
 \item \texttt{git status}
 \item \texttt{git commit -m "{}New content of README"{}} %\quad \visible<4->{{\scriptsize Fehler absichtlich}}
 \item \texttt{git status}
\end{itemize}
\pause
 \item Änderungen durchführen, anzeigen und committen
\begin{itemize}
 \item \texttt{sed -i {-}{-} '{}s/Welt/Leute/g{}' README.md}
 \item \texttt{git diff}
 \pause
 \pause
