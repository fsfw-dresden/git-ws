...
\begin{itemize}
\vspace{-3mm}
   \item Umundu-Festival (01. - 06. Okt.) \quad \hspace{12mm}\raisebox{-8mm}{\includegraphics[width=2cm]{img-src/umundu-10-bild.jpg}}
   \begin{itemize}
...
\hspace{12mm}\raisebox{-1mm}{\includegraphics[width=2cm]{img-src/kreta-logo-2018}}
